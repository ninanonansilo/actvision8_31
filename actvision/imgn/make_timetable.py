...
def make_Timetable_text():
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(first_time_year);
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(second_time_year);
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(third_time_year);
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(fourth_time_year);
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(fifth_time_year);
    ...
    info = {}
    info["time"] = {}
    info["time"]["year"] = str(sixth_time_year);
